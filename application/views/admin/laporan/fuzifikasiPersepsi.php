...
<body id="page-top">
	...
	<div id="wrapper">
        ...
        -->
				...
				<!-- Icon Cards-->
				<div class="container">
					<h4 class="mt-3"> Data Laporan Hasil fuzzyfikasi Persepsi </h4>
              ...
              // print_r($kuesioner);
               ...
               if(empty($jawaban)){
				...
				// mengecek semua count apakah sama jika iya maka lakukan for untuk menampilkan
				// print_r(count($batasBawah));
				// print_r(count($batasTengah));
				// print_r($kuesioner);
