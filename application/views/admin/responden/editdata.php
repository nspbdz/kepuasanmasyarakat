...
<body>  
        ...
        <div class="card-body">
          ...
          <select class="form-control" id="dimensi_id" name="dimensi_id" required>
               <option value="0">Pilih Dimensi</option>
                ...
                <option value="<?php echo $kuesioner->dimensi_id; ?>"<?php if($items->id==$kuesioner->dimensi_id) echo 'selected="selected"'; ?>><?php echo $items->nama; ?></option>
  ...
  var idText=$("#myTextarea").val("<?php echo $kuesioner->pertanyaan;?>")
        ...
        <div class="card-footer">
          ...
          <a href="<?php echo base_url('admin/kuesioner');?>" class="btn btn-default">Batal</a>
